...
## column for time and a column for date
mls_xgs_long


mls_xgs_long$date <- as.Date(mls_xgs_long$date_time_utc)

# Extract the time
mls_xgs_long$time <- format(ymd_hms(mls_xgs_long$date_time_utc), "%H:%M:%S")
